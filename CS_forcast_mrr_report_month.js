...
function refresh()
{
    var fromDate = nlapiGetFieldValue('from_date');
    var toDate = nlapiGetFieldValue('to_date');
   
    if(fromDate && toDate)
    {   
        window.ischanged = false;
        var param = '&from_date=' + fromDate;
        param += '&to_date=' + toDate;
        
        window.location.href = 'https://system.na2.netsuite.com/app/site/hosting/scriptlet.nl?script=80&deploy=1' + param;
    } else {
...
var exportExcel = (function() {
    ...
    var uri = 'data:application/vnd.ms-excel;base64,'
      ...
      //  window.location.href = uri + base64(format(template, ctx))
        ...
        a.download = 'Forcast MRR Report by Month_' + tag + '.xls';
